...
# This script downloads and installs the Wazuh agent on Debian-based Linux distributions.
# It automatically uses the machine's hostname as the agent name.

AGENT_PKG="wazuh-agent_4.7.5-1_amd64.deb"
AGENT_URL="https://packages.wazuh.com/4.x/apt/pool/main/w/wazuh-agent/${AGENT_PKG}"
...
wget ${AGENT_URL} && \
sudo WAZUH_MANAGER="${WAZUH_MANAGER_IP}" WAZUH_AGENT_NAME="$HOSTNAME" WAZUH_REGISTRATION_SERVER="${WAZUH_MANAGER_IP}" dpkg -i ./${AGENT_PKG}
